...
FIXTURES: dict[str, BlockFixture] = {
    ...
    "/org/freedesktop/UDisks2/block_devices/sdc": BlockFixture(
        Device=b"/dev/sdc\x00",
        PreferredDevice=b"/dev/sdc\x00",
        Symlinks=[
            b"/dev/disk/by-id/usb-Seagate_Expansion_1234567890-0:0\x00",
            b"/dev/disk/by-path/platform-xhci-hcd.1.auto-usb-0:1.3:1.0-scsi-0:0:0:0\x00",
        ],
        DeviceNumber=2080,
        Id="by-id-usb-Seagate_Expansion_1234567890-0:0",
        Size=2000398934016,
        ReadOnly=False,
        Drive="/org/freedesktop/UDisks2/drives/Seagate_Expansion_1234567890",
        MDRaid="/",
        MDRaidMember="/",
        IdUsage="",
        IdType="",
    ...
    "/org/freedesktop/UDisks2/block_devices/sdc1": BlockFixture(
        Device=b"/dev/sdc1\x00",
        PreferredDevice=b"/dev/sdc1\x00",
        Symlinks=[
            b"/dev/disk/by-id/usb-Seagate_Expansion_1234567890-0:0-part1\x00",
            b"/dev/disk/by-label/Backups\x00",
            b"/dev/disk/by-partuuid/9c4f2b7e-1d3a-4f8b-9e2c-5a7d1b3f6e88\x00",
            b"/dev/disk/by-path/platform-xhci-hcd.1.auto-usb-0:1.3:1.0-scsi-0:0:0:0-part1\x00",
            b"/dev/disk/by-uuid/d2f4a6c8-3b5e-4079-8a1c-6e9d2f4b7a30\x00",
        ],
        DeviceNumber=2081,
        Id="by-id-usb-Seagate_Expansion_1234567890-0:0-part1",
        Size=2000397795328,
        ReadOnly=False,
        Drive="/org/freedesktop/UDisks2/drives/Seagate_Expansion_1234567890",
        MDRaid="/",
        ...
        IdVersion="1.0",
        IdLabel="Backups",
        IdUUID="d2f4a6c8-3b5e-4079-8a1c-6e9d2f4b7a30",
        Configuration=[],
        CryptoBackingDevice="/",
        HintPartitionable=True,
        HintSystem=False,
