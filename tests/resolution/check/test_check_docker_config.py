...
async def test_check(
    ...
    docker.containerspy.get = _make_mock_container_get(
...
async def test_addon_volume_mount_not_flagged(
    ...
    docker.containerspy.get = _make_mock_container_get_with_volume_mount(
...
async def test_addon_configured_mount_still_flagged(
    ...
    docker.containerspy.get = mock_container_get
