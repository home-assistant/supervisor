...
def test_extract_complete_layer():
...
def test_download_complete_not_extracted():
...
def test_extraction_progress_overlay2():
...
def test_all_layers_already_exist():
...
def test_single_layer_download():
...
def test_multiple_layers_equal_weight_progress():
...
def test_containerd_extract_progress():
...
def test_overlay2_extract_progress():
...
def test_events_without_status_ignored():
...
def test_mixed_already_exists_and_pull():
...
def test_pending_layers_prevent_premature_100():
...
def test_large_layers_appearing_late_dont_cause_regression():
...
def test_size_weighted_progress_with_manifest():
...
def test_size_weighted_excludes_already_exists():
...
def test_fallback_to_count_based_without_manifest():
