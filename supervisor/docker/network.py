...
class DockerNetwork:
    ...
    def attach_container(
        ...
        try:
            ...
            raise DockerError(f"Can't link container to hassio-net: {err}", _LOGGER.error)  from err
    ...
    def detach_default_bridge(
        ...
        try:
            ...
            raise DockerError(f"Can't disconnect container from default: {err}", _LOGGER.warning) from err
