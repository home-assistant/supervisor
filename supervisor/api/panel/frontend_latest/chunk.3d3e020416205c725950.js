/*! For license information please see chunk.3d3e020416205c725950.js.LICENSE.txt */
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[929],{7087:(e,t,i)=>{"use strict";i(1309),i(5660);var r=i(6110),n=i(8235),a=i(7139),o=i(8149),s=i(856);(0,a.k)({_template:s.d`
    <style>
      :host {
...
<div id="checkboxLabel"><slot></slot></div>`;f.setAttribute("strip-whitespace",""),(0,h.k)({_template:f,is:"paper-checkbox",behaviors:[u],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){(0,p.T8)(this,(function(){if("-1px"===this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim()){var e=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),t="px",i=e.match(/[A-Za-z]+$/);null!==i&&(t=i[0]);var r=parseFloat(e),n=8/3*r;"px"===t&&(n=Math.floor(n))%2!=r%2&&n++,this.updateStyles({"--paper-checkbox-ink-size":n+t})}}))},_computeCheckboxClass:function(e,t){var i="";return e&&(i+="checked "),t&&(i+="invalid"),i},_computeCheckmarkClass:function(e){return e?"":"hidden"},_createRipple:function(){return this._rippleContainer=this.$.checkboxContainer,s.S._createRipple.call(this)}})},5782:(e,t,i)=>{"use strict";i(1309),i(5660),i(19),i(7968);var r=i(7139),n=i(856),a=i(3760);(0,r.k)({_template:n.d`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[a.U]})},1548:(e,t,i)=>{"use strict";i(5660),i(7956);var r=i(1309);const n={properties:{value:{type:Number,value:0,notify:!0,reflectToAttribute:!0},min:{type:Number,value:0,notify:!0},max:{type:Number,value:100,notify:!0},step:{type:Number,value:1,notify:!0},ratio:{type:Number,value:0,readOnly:!0,notify:!0}},observers:["_update(value, min, max, step)"],_calcRatio:function(e){return(this._clampValue(e)-this.min)/(this.max-this.min)},_clampValue:function(e){return Math.min(this.max,Math.max(this.min,this._calcStep(e)))},_calcStep:function(e){if(e=parseFloat(e),!this.step)return e;var t=Math.round((e-this.min)/this.step);return this.step<1?t/(1/this.step)+this.min:t*this.step+this.min},_validateValue:function(){var e=this._clampValue(this.value);return this.value=this.oldValue=isNaN(e)?this.oldValue:e,this.value!==e},_update:function(){this._validateValue(),this._setRatio(100*this._calcRatio(this.value))}};var a=i(7139),o=i(856);(0,a.k)({_template:o.d`
    <style>
      :host {
        display: block;
        width: 200px;
...
//# sourceMappingURL=chunk.3d3e020416205c725950.js.map