        ...
        <div class="card-content">
          ...
          <ha-chip-set class="capabilities">
            ...
            <ha-chip
              ...
              id="rating"
            >
              <ha-svg-icon slot="icon" .path=${Re[this.addon.rating]}>
              </ha-svg-icon>
          ...
          ${this._error?i.dy`<ha-alert alert-type="error">${this._error}</ha-alert>`:""}
          ${this.addon.version||!s||this.addon.available?"":(0,xe.I)(this.supervisor.info.supported_arch,this.addon.arch)?i.dy`
...
//# sourceMappingURL=62a9098b.js.map