        ...
        <div class="card-content">
          ...
          <ha-chip-set class="capabilities">
            ${"stable"!==this.addon.stage?i.dy` <ha-chip
                  hasIcon
                  class=${(0,ye.$)({yellow:"experimental"===this.addon.stage,red:"deprecated"===this.addon.stage})}
                  @click=${this._showMoreInfo}
                  id="stage"
                >
                  <ha-svg-icon
                    slot="icon"
                    .path=${Ue[this.addon.stage]}
                  >
                  </ha-svg-icon>
            ...
            <ha-chip
              hasIcon
              class=${(0,ye.$)({green:Number(this.addon.rating)>=6,yellow:[3,4,5].includes(Number(this.addon.rating)),red:Number(this.addon.rating)>=2})}
              @click=${this._showMoreInfo}
              id="rating"
            >
              <ha-svg-icon slot="icon" .path=${Ze[this.addon.rating]}>
              </ha-svg-icon>
          ...
          <div class="addon-container">
            <div>
              ...
              ${this.addon.version?i.dy`
                    <div
                      class=${(0,ye.$)({"addon-options":!0,started:"started"===this.addon.state})}
                    >
