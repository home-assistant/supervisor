...
class Ip6Setting(IpSetting):
    ...
    addr_gen_mode: InterfaceAddrGenMode = InterfaceAddrGenMode.EUI64
    ip6_privacy: InterfaceIp6Privacy = InterfaceIp6Privacy.ENABLED
...
class Interface:
    ...
    def _map_nm_ip6_privacy(ip6_privacy: int) -> InterfaceIp6Privacy:
        ...
        return mapping.get(ip6_privacy, InterfaceIp6Privacy.ENABLED)
