...
from ..const import (
    ...
    ATTR_DEVICES, ATTR_DEVICETREE, ATTR_DISCOVERY, ATTR_DOCKER_API,
    ATTR_ENVIRONMENT, ATTR_FULL_ACCESS, ATTR_GPIO, ATTR_HASSIO_API,
    ATTR_HASSIO_ROLE, ATTR_HOMEASSISTANT_API, ATTR_HOST_DBUS, ATTR_HOST_IPC,
    ATTR_HOST_NETWORK, ATTR_HOST_PID, ATTR_IMAGE, ATTR_KERNEL_MODULES,
    ATTR_LEGACY, ATTR_LOCATON, ATTR_MACHINE, ATTR_MAINTAINER, ATTR_MAP,
...
SCHEMA_ADDON_USER = vol.Schema({
    vol.Required(ATTR_VERSION): vol.Coerce(str),
    vol.Required(ATTR_IMAGE, default=None): vol.Maybe(vol.Coerce(str)),
